...
export const metadata: Metadata = {
  ...
  metadataBase: new URL('https://desenrolaai.tech'),
  alternates: { canonical: 'https://desenrolaai.tech/' },
  openGraph: {
    type: 'website',
    url: 'https://desenrolaai.tech',
  ...
  icons: {
    ...
    other: [
      { rel: 'icon', type: 'image/png', sizes: '32x32', url: '/favicons/icon-32x32.png' },
      { rel: 'icon', type: 'image/png', sizes: '16x16', url: '/favicons/icon-16x16.png' },
    ],
  },
};
